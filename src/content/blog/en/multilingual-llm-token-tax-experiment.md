...
Third, my corpus is a tech blog, so the bodies are heavy with English code, proper nouns, and technical terms. Pure everyday Korean prose could show a bigger multiplier. So this 1.38x is "my environment, technical-document baseline," not a universal constant. If you want to dig deeper into tokenizer behavior, my [post on LLM fundamentals](/en/blog/en/dena-llm-study-part1-fundamentals) is an adjacent starting point.
