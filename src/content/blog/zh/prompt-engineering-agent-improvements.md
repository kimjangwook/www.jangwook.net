...
| 方面 | 现有方式 | 改进方式 | 差异 |
|------|-----------|-----------|--------|
| **角色** | "~支持"(隐性) | "You are X with Y experience"(显性) | 明确身份 |
| **专业性** | 功能列表 | 专业领域 + 经验年数 | 建立权威 |
| **边界** | 不明确 | DO/DON'T明确 | 防止角色冲突 |

### 2. 信息提供方式

| 方面 | 现有方式 | 改进方式 | 差异 |
|------|-----------|-----------|--------|
| **不确定信息** | 推测回答 | 明确"不知道" | 防止幻觉 |
| **出处** | 选择性提供 | 所有信息必须有 | 可验证性 |
| **确定性** | 无显示 | High/Medium/Low/Unknown | 明确可靠性 |

### 3. 质量管理方式

| 方面 | 现有方式 | 改进方式 | 差异 |
|------|-----------|-----------|--------|
| **检查清单** | 简单(4-10项) | 详细(30+项) | 防止遗漏 |
| **验证** | 事后确认 | 事前自我验证 | 质量保证 |
| **一致性** | 每个代理不同 | 统一结构 | 易于维护 |
