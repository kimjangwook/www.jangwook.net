...
在生产环境中实现这种明确委派模式，[LangGraph多代理系统](/zh/blog/zh/langgraph-multi-agent)是一个很好的起点。
...
AI代理的性能不在于"有多聪明",而在于"有多诚实"。明确不确定性、提供出处、系统性验证的代理长期来看最受信任。如果还想提升代理的输出多样性，可以参考[Verbalized Sampling技术](/zh/blog/zh/claude-code-verbalized-sampling)。
