...
本文的所有配置都基于Langfuse官方资料进行了验证。如果你想亲自动手，建议把[Langfuse官方网站](https://langfuse.com)、[GitHub仓库](https://github.com/langfuse/langfuse)以及[Docker Compose自托管文档](https://langfuse.com/self-hosting/deployment/docker-compose)放在旁边一起看。版本变动频繁，因此环境变量名称和端口务必以官方文档作为一手来源来确认。
