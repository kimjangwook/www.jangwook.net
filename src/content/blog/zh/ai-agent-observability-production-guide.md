...
将AI智能体部署到生产环境后，最常被问到的两个问题是："为什么会给出这样的回答？"以及"这花了多少钱？"在多智能体系统中，如果无法快速回答这两个问题，可以认为该系统已经失控。[多智能体编排架构](/zh/blog/zh/multi-agent-orchestration-improvement)越复杂，可观测性的重要性就越高。
...
对于集成了MCP工具的智能体，[用mcp2cli将MCP Token成本削减96〜99%](/zh/blog/zh/mcp2cli-token-cost-optimization)是改善成本指标的关键杠杆。
...
生产环境AI系统的可靠性，不是从更好的模型开始的，而是从更好的观察开始的。在成本优化方面，[Claude API提示词缓存降本指南](/zh/blog/zh/claude-api-prompt-caching-cost-optimization-guide)是与可观测性体系配套使用的重要参考。
