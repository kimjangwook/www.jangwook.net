...
**4. AI代理集群监督**
当多个AI代理并行工作时，协调哪个代理负责哪项任务，以及确保各输出结果相互兼容。[Claude Code智能体工作流模式5种](/zh/blog/zh/claude-code-agentic-workflow-patterns-5-types)展示了如何通过具体示例实现这一协调角色。
...
这种方式能更准确地衡量候选人的实际工作能力。将Anthropic推出的[Claude Code Review — 多智能体PR审查功能](/zh/blog/zh/claude-code-review-multi-agent-pr)作为审计材料，可以在真实工具环境中评估候选人的AI代码审计能力。
