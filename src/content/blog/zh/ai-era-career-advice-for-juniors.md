---
title: AI时代，想对后辈们说的话
description: 在AI缩减招聘的时代，分享从中小企业5年开发经验中提炼的生存策略。深入积累领域知识、以T型人才方式成长、并与AI协作提升个人价值的方法，坦诚整理如下。从初级到高级开发者都适用的AI时代职业发展路线图。
pubDate: '2025-12-02'
...
当你拥有这些，你就不是在和AI竞争，而是在<strong>用AI作为你的超级助手</strong>。你提供方向和判断，AI提供执行力和效率。这才是真正的人机协作。实际搭建一个像[Claude Agent Teams这样由多个专业代理协作的系统](/zh/blog/zh/claude-agent-teams-guide)，你会切实感受到T型理解力有多关键。
...
我观察到一个趋势：越来越多的公司在寻找既有领域知识，又愿意积极拥抱AI的人。像[用uv在0.87秒内搭好AI开发环境](/zh/blog/zh/uv-python-ai-development-setup-guide-2026)这样，快速上手新工具是拥抱AI的第一步。他们不只是要会用工具的人，而是要能用工具解决真实业务问题的人。
