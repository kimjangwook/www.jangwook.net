...
AI代理陷入同样的模式意味着<strong>治理设计原则与人类管理相通</strong>。有趣的是，[实证研究表明过于详细的上下文文件(AGENTS.md)实际上会降低代理性能](/zh/blog/zh/agents-md-effectiveness)。规则质量比数量更重要的原则，同样适用于KPI设计。
...
利用研究发现的"深思熟虑的不对齐"，<strong>让另一个代理担任评估者角色</strong>的架构是有效的。参考[为AI代理赋予特定人格和性别时行为如何改变的研究](/zh/blog/zh/ai-agent-persona-analysis)，有助于为审计代理设计合适的角色定位。
