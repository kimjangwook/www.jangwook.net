...
<strong>Frontier Red Team</strong>是对AI系统极限能力进行压力测试的团队。近期的代表性项目是利用Claude在Firefox代码库中自主发现22个CVE（安全漏洞）。不仅仅是发现漏洞，还测试了AI能否自主利用这些漏洞进行攻击。
...
Anthropic自身也表示这是"需求最高的企业工作负载"。这反映了其判断：Claude的智能体编程能力在这一领域最能直接转化为客户成果。
