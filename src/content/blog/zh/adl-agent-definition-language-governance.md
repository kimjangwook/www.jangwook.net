...
通过这种方式，CTO可以通过仪表板确认"当前组织运营多少个智能体，每个智能体对哪些系统拥有访问权限"。结合[将多角色智能体组织为团队的方法](/zh/blog/zh/claude-agent-teams-guide)与ADL目录，可以使整个组织的AI治理体系更加具体落地。
...
虽然仍处于早期阶段，但作为Apache 2.0许可证的开源标准，现在是时候开始关注并考虑试点导入了。参考[企业AI采用决策框架](/zh/blog/zh/enterprise-ai-adoption-topdown)评估组织准备度后再确定ADL导入范围，是更为务实的做法。
