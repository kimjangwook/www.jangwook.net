...
SWE-Bench Verified는 실제 GitHub 이슈를 해결하는 능력을 측정하는 벤치마크입니다. [멀티 에이전트 시스템의 SWE-Bench 성능](/ko/blog/ko/multi-agent-swe-bench-verdent)도 함께 참고해 보세요.
...
M2.5의 충격은 성능만이 아닙니다. <strong>비용 대비 성능</strong>이 차원이 다릅니다. [2026년 주요 LLM API 가격 비교](/ko/blog/ko/llm-api-pricing-comparison-2026-gpt5-claude-gemini-deepseek)와 함께 살펴보면 그 차이가 더욱 선명하게 드러납니다.
