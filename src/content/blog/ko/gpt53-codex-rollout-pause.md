...
이 글에서는 GitHub Codex 롤백 사건의 배경과 원인을 분석하고, 엔지니어링 매니저(EM)의 관점에서 AI 모델 버전업 리스크를 어떻게 관리해야 하는지 논의합니다. AI 모델 의존도 증가가 가져오는 또 다른 리스크는 [GPT-4o 서비스 종료가 불러온 모델 의존성 위험 분석](/ko/blog/ko/gpt4o-retirement-model-dependency-risk)에서 함께 살펴볼 수 있습니다.

## 사건 경위

### GPT-5.3 Codex란?

GitHub Copilot의 코어 엔진인 Codex는 OpenAI의 GPT 모델을 기반으로 코드 생성, 자동 완성, 코드 리뷰 등의 기능을 제공합니다. [Greptile의 AI 코딩 현황 리포트](/ko/blog/ko/greptile-ai-coding-report-2025-review)에 따르면, 개발자들의 AI 코딩 도구 의존도는 이미 돌이킬 수 없는 수준에 달해 있어 이런 서비스 장애의 파급력이 더욱 커졌습니다. GPT-5.3으로의 업그레이드는 다음과 같은 개선을 목표로 했습니다:
