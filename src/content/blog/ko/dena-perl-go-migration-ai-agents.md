...
- **Perl의 미래 전망**: 언어의 장래성과 커뮤니티 축소에 대한 우려
- **보수성 문제**: 신규 개발자 채용 시 Perl 경험자 확보가 어려움
- **공수 문제**: 마이그레이션의 필요성은 인식하면서도, 기존 업무 우선순위에 밀려 착수하지 못하는 상황

DeNA IT본부 IT기반부 소이케 부부장은 "공수가 많이 드는 것이 눈에 보여, 우선순위 문제로 도저히 대응하지 못했다"고 말합니다.
...
- **2개월간의 검증 기간**을 별도로 확보한 점에 주목해야 합니다. AI가 변환한 코드라도 본번 투입 전에 충분한 검증이 필수입니다.
...
"AI로 이만큼 효율화할 수 있다면, 지금까지 공수 문제로 손대지 못했던 안건에도 착수할 수 있게 된다"는 소이케 부부장의 말처럼, AI 에이전트는 기술 부채 해소의 새로운 돌파구가 될 수 있습니다.
