...
NVIDIA DGX Spark는 "$3,000 개인용 AI 슈퍼컴퓨터"라는 타이틀로 2025년 CES에서 발표되었습니다. 128GB 통합 메모리와 Blackwell 아키텍처를 탑재한 데스크톱급 AI 워크스테이션이라는 포지셔닝이었죠. 하지만 실제 사용자들의 리포트는 마케팅과 상당히 다른 현실을 보여주고 있습니다.
