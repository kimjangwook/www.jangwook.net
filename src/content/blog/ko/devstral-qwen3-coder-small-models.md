...
[Claude Code](/ko/blog/ko/claude-code-masterclass-series-1-prompt-to-agent)와의 통합도 지원하여, 기존 개발 워크플로우에 자연스럽게 통합할 수 있습니다.
...
2. <strong>비용 절감</strong>: [API 비용](/ko/blog/ko/claude-code-local-model-inefficiency) 없이 자체 하드웨어에서 무제한 사용 가능합니다
