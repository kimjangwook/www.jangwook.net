...
2025년 11월, 나는 <strong>Agent Effi Flow</strong>라는 이름으로 AI 기반 업무 효율화 SaaS를 런칭했다. "영수증 OCR로 경리 업무를 자동화하자"라는 단순한 아이디어에서 시작했다.
...
하지만 런칭 후 일주일, 냉정한 현실을 마주해야 했다. 이 서비스의 초기 자동화 구조를 어떻게 설계했는지는 [Agent Effi Flow 자동화 분석 1편](/ko/blog/ko/effiflow-automation-analysis-part1)에서 자세히 다뤘다.
...
일본의 경리 자동화 시장을 조사하면서 충격적인 사실을 발견했다.
...
<strong>영수증 OCR</strong>은 이미 이 거대 플레이어들의 <strong>기본 기능</strong>이었다. 1인 개발자가 이 시장에서 차별화를 만들어내기란 불가능에 가까웠다.
...
일본은 세계 3위 경제 대국이지만, 디지털 경쟁력은 OECD 최하위권이다. 이 <strong>디지털 역설</strong> 속에서 기회를 발견했다.
...
<strong>집객 → 접객 → 정산</strong>의 일관된 고객 여정을 AI로 지원하는 것이 새로운 비전이다.
...
2025년 12월 3일, <strong>おもてなしBot</strong>을 정식 런칭했다.

> "실수 없는 완벽한 다국어 응대"

메뉴판 사진을 업로드하면 <strong>13개 언어</strong>로 문화적 맥락을 반영한 번역을 제공한다.
...
おもてなしBot의 핵심은 <strong>문화적 맥락을 이해하는 프롬프트</strong>다.

#### 언어별 문화 가이드라인

각 타겟 언어에 대해 문화적 특성을 정의했다.
...
소상공인이 부담 없이 쓸 수 있는 합리적인 가격을 설정했다.

---

## 경리 OCR: 전략적 일시 정지

기존 경리 OCR 기능은 <strong>일시 정지</strong>했다.
...
경리 OCR은 단순 영수증 인식이 아닌, <strong>인바운드 매출 특화</strong> 기능으로 재탄생할 예정이다.

- 면세/과세 자동 분류
- Duty-Free, Tax-Free 키워드 감지
- 야요이, freee CSV 포맷 지원

이러한 자동화 파이프라인을 실제로 어떻게 운영하고 개선해 왔는지는 [Agent Effi Flow 자동화 분석 3편](/ko/blog/ko/effiflow-automation-analysis-part3)에서 이어진다.
...
아무리 좋은 기술도 레드오션에서는 빛을 발하기 어렵다. <strong>경쟁이 적은 시장</strong>을 찾는 것이 1인 개발자에게는 생존 전략이다.

### 2. 니치를 깊게 파라

"모든 사람을 위한 서비스"보다 "특정 고객의 구체적인 문제 해결"이 훨씬 가치 있다.

### 3. 피벗은 실패가 아니다

방향 전환은 포기가 아니다. 시장의 피드백을 받아들이고 더 나은 기회를 찾아가는 <strong>전략적 결정</strong>이다.

### 4. 문화적 맥락이 차별화다

AI 번역 서비스는 많지만, <strong>문화적 맥락</strong>을 이해하는 서비스는 드물다. 이것이 おもてなしBot의 핵심 경쟁력이다.
...
2026년 면세 처리 방식의 변화에 발맞춰, 인바운드 고객을 대상으로 면세 처리를 실시하는 소상공인을 위한 면세 처리용 영수증 OCR 기능을 더욱 강화할 계획이다.

---

## 마무리

레드오션에서 허우적거리던 경리 OCR 서비스가, 인바운드 관광이라는 블루오션에서 새로운 가능성을 발견했다.

<strong>おもてなしBot</strong>은 그 첫 번째 결실이다. "가게를 지키는 AI 지배인"이라는 비전 아래, 일본의 소상공인들이 전 세계 손님을 맞이할 수 있도록 계속 발전시켜 나간다.

---

<strong>서비스 바로가기</strong>: [Agent Effi Flow](https://agent-effi-flow.jangwook.net/)

피드백이나 질문이 있으면 언제든 연락하면 된다. 함께 더 나은 서비스를 만들고 싶다.
