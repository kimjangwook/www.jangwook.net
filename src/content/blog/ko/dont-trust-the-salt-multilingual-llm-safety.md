...
<strong>핵심 발견</strong>: Q&A 태스크보다 요약 태스크에서 모델 출력을 조종하는 것이 <strong>훨씬 쉽습니다</strong>. 이는 기업이 의존하는 경영진 보고서 생성, 정치 토론 요약, UX 리서치, 챗봇 메모리 시스템 등 모든 요약 기반 워크플로우에 직접적 영향을 미칩니다.
...
Q&A보다 요약에서 편향 조작이 더 쉽습니다. 요약 기반 워크플로우(보고서 생성, 챗봇 메모리, 리뷰 요약 등)에 대한 특별한 검증이 필요합니다.
