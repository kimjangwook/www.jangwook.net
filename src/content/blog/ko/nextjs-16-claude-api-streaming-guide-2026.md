---
title: 'Next.js 16 + Claude API로 스트리밍 AI 채팅 앱 만들기 — App Router 완전 가이드'
description: 'Next.js 16 App Router에서 Claude API 스트리밍을 연결하는 실전 가이드. Route Handler, SSE, React 19 클라이언트 통합까지 실제 빌드한 코드와 로그로 설명한다.'
pubDate: '2026-05-20'
