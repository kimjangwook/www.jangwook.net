...
*   <strong>48시간 공백(48h gap)</strong>: 특정 조건에서 다음 실행 시간이 비정상적으로 지연됨 (#10025)
*   <strong>게이트웨이 재시작 버그</strong>: 재시작 시 스케줄 로드 실패 (#10045)
*   <strong>NextRunAtMs 갱신 오류</strong>: 실행 없이 시간만 갱신되는 현상 (#10201)
