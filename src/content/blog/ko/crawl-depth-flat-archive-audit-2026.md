...
description: '관련 글이 평균 8개씩 걸린 사이트의 내부 링크를 도달성 기준으로 다시 셌다. 빌드된 HTML 1,330장을 너비 우선 탐색하니 글 1,288편 중 1,276편이 깊이 2였다. 그런데 언어별 목록 페이지 네 장을 링크 그래프에서 빼자 296편이 홈에서 닿지 않았다.'
pubDate: '2026-07-30'
