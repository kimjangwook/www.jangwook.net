...
[지난 글에서 Paperclip이라는 AI 에이전트 오케스트레이션 플랫폼을 설치하고 돌려봤다](/ko/blog/ko/paperclip-zero-human-company-agent-orchestration/). 에이전트를 고용하고, 이슈를 할당하고, 코드를 커밋하는 데까지 확인했는데 — 거기서 멈추기가 아까웠다.
