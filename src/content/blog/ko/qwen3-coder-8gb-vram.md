...
3. <strong>하드웨어 발전이 격차를 좁힌다</strong>: 차세대 GPU에서는 실용적 속도에 도달할 가능성. [llama.cpp의 컴퓨트 그래프 최적화](/ko/blog/ko/qwen3-coder-next-llama-cpp-graph-optimization)처럼 소프트웨어 수준의 접근법도 이 격차를 빠르게 좁히고 있습니다.
...
로컬 LLM에 관심 있는 개발자라면 [nalexand의 GitHub 저장소](https://github.com/nalexand/Qwen3-Coder-OPTIMIZED)를 확인하고, 자신의 하드웨어에서 직접 실험해보는 것을 추천합니다. VRAM 사용량을 더욱 줄이려면 [4bit 양자화로 VRAM을 최대 70% 절감하는 Heretic 1.2 기법](/ko/blog/ko/heretic-12-vram-reduction)도 함께 참고해보세요.
