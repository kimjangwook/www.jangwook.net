...
프로덕션 환경에서 이런 명시적 위임 패턴을 구현하려면 [LangGraph 멀티 에이전트 시스템](/ko/blog/ko/langgraph-multi-agent)이 좋은 출발점이 됩니다.
...
AI 에이전트의 성능은 "얼마나 똑똑한가"보다 "얼마나 정직한가"에 달려 있습니다. 불확실성을 명시하고, 출처를 제공하며, 체계적으로 검증하는 에이전트가 장기적으로 가장 신뢰받습니다. 에이전트의 출력 다양성까지 높이고 싶다면 [Verbalized Sampling 기법](/ko/blog/ko/claude-code-verbalized-sampling)도 함께 검토해보세요.
