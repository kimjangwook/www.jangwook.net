...
이 성과는 arXiv에 프리프린트로 공개되었으며, 프린스턴 고등연구소, 하버드 대학교, 케임브리지 대학교 연구자들과의 공동 연구로 발표되었습니다. AI가 과학 연구에서 '도구'에서 '발견자'로 변하는 역사적인 전환점이라 할 수 있습니다. 2026년 2월은 이 성과를 포함해 AI 모델 발전이 유독 집중된 달이었는데, [2026년 2월 AI 모델 러시 총정리](/ko/blog/ko/ai-model-rush-february-2026)에서 당시 전체 흐름을 확인할 수 있습니다.
...
12시간에 걸친 형식적 증명 완성은, AI가 짧은 응답뿐 아니라 장시간의 깊은 사고가 가능함을 보여줍니다. [MIT의 자기 커리큘럼 추론 연구(SOAR)](/ko/blog/ko/mit-soar-self-curriculum-reasoning)도 AI가 스스로 학습 과제를 설계하며 추론 능력을 확장하는 유사한 방향성을 보여줍니다.
...
- <strong>AI 추론 능력의 진화</strong>: 12시간 연속 추론과 형식적 증명은 코드 생성이나 버그 수정을 넘어선 능력을 시사. [IBM의 GenZ 개발자 채용에서 나타난 AI 한계 분석](/ko/blog/ko/ibm-gen-z-hiring-ai-limits)에서 현장에서 요구되는 역량이 어떻게 바뀌고 있는지 살펴볼 수 있습니다.
