...
- **키워드 일치가 의미 유사도보다 중요할 때.** 정확한 용어·코드·고유명사 매칭이 핵심이면 임베딩보다 BM25 같은 키워드 검색이 낫다. 실무에서는 둘을 합친 [하이브리드 검색](/ko/blog/ko/llamaindex-vs-langchain-vs-haystack-rag-2026)이 정답인 경우가 많다.
