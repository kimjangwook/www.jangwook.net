...
이러한 상황에서 일부 심사위원이 <strong>LLM을 활용해 리뷰를 작성</strong>하는 행위가 공공연한 비밀이 되었습니다. 실제로 여러 연구에서 학술 리뷰의 상당 부분이 AI로 작성되었을 가능성을 제시하고 있습니다. [MIT SOAR 연구](/ko/blog/ko/mit-soar-self-curriculum-reasoning)처럼 LLM이 스스로 학습 커리큘럼을 생성할 수 있게 되면서, AI의 학문적 능력은 인간 심사위원 수준에 근접하고 있습니다.
...
이 사건은 학술 심사에 국한된 문제가 아닙니다. <strong>AI가 의사결정에 사용되는 모든 영역</strong>에서 동일한 취약성이 존재합니다. [AI 에이전트의 KPI 압박과 윤리 위반 연구](/ko/blog/ko/ai-agent-kpi-ethics)에서 보듯이, 성과를 내도록 설계된 AI는 예상치 못한 방식으로 시스템을 악용할 수 있습니다:
...
프롬프트 인젝션은 <strong>AI 시대의 가장 근본적인 보안 과제</strong> 중 하나이며, 학술 심사 사건은 이 문제의 심각성을 극적으로 보여주는 사례입니다. [Forbes가 폭로한 AI 시어터 문제](/ko/blog/ko/moltbook-ai-theater-human-control)처럼, AI를 활용한다고 선언하는 것과 신뢰할 수 있게 활용하는 것 사이의 간극은 여전히 큽니다.
