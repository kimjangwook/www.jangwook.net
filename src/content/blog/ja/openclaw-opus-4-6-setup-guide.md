...
2026年2月5日、AnthropicがClaude Opus 4.6をリリースした。**100万トークンコンテキスト**、**128Kトークン出力**、強化された計画力と自己修正能力。

OpenClawユーザーなら、今すぐ設定して使い始めたいはずだ。

この記事では、**設定ファイルをそのままコピペして即座に動かせる**最短手順を紹介する。
...
**ポイント**:
- `mode: "merge"` — OpenClawの組み込みモデルカタログに**追加**する（置き換えではない）
