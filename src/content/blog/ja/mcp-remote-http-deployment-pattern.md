...
サーバーレス上にエージェントを載せる流れ自体は広がり続けている。[Cloudflare Agents Week 2026の発表を整理したとき](/ja/blog/ja/cloudflare-agents-week-2026-autonomous-infrastructure/)に確認した制約も、結局は同じものだった。リクエストごとに実行コンテキストが初期化されるランタイムでは、状態をランタイムの外に置くしかない。
