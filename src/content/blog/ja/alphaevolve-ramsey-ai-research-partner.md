...
ただし、この表には抜けている軸がひとつあります。AlphaEvolveは人が評価関数さえ決めれば残りを自力で探索しますが、逆に人が一段階ごとに方向を与えるやり方も成立します。ハーバードの物理学教授がClaudeを大学院生のように指導し、二週間で論文を仕上げた[Vibe Physicsの実験](/ja/blog/ja/anthropic-vibe-physics-ai-research-assistant/)が、その反対側の極です。自動探索と密着指導のどちらが合うかは、問題が評価可能な形になっているかで決まります。
