...
description: >-
  DeNA LLMスタディシリーズ開始。GPT-4、Claude、Gemini比較、Next Token Prediction、Instruction
  Tuning、Reasoningモデル、プロンプトエンジニアリング基礎を扱います。
pubDate: '2025-12-08'
...
基礎をまとめた記事なので、誰にとっても同じように必要というわけではありません。自分の立ち位置に合わせて読む深さを調整してください。

<strong>この記事が特に役立つ場合</strong>

- LLMを使い始めたばかりで、「トークンとは何か」「なぜTemperatureをいじるのか」から整理したい人
- プロンプトを感覚で書いていて精度がばらつくため、Zero-shot/Few-shot/CoTの違いを一度整理したい人
- チームにモデルを推薦する必要があり、GPT・Claude・Gemini・DeepSeekのどれを基準に選ぶか迷っている人
- 社内勉強会や新人オンボーディング向けに「LLM一枚要約」が欲しい人
