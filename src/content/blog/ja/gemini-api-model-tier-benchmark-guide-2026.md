...
モデル選択だけがコストを下げる方法ではない。ティアを変える前に[Thinking予算をタスク種別ごとに調整してみる](/ja/blog/ja/gemini-25-flash-thinking-api-developer-guide-2026/)手もある。同じモデルでも、予算設定ひとつでレイテンシと出力トークンが同時に動く。
