...
最初の項目がこの手法の性格を決めている。SSRは実際のアンケートを置き換える道具ではなく、どのアンケートを先に回すかを決める道具だ。この結論にたどり着くまでsynthetic panelを実際の製品として作りながら踏んだ回り道は、[InsightForgeを検証優先順位のツールとして定義し直した記録](/ja/blog/ja/why-i-built-insightforge-validation-priorities/)に残した。
