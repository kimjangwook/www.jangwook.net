...
![OpenClaw公式ドキュメント — Gatewayアーキテクチャと全機能の説明](../../../assets/blog/docs-main.png)
...
![OpenClawマルチエージェントルーティングドキュメント — エージェントごとのサンドボックス、ツール制限、ルーティングルール設定](../../../assets/blog/docs-multi-agent.png)
