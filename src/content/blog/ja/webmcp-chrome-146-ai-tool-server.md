...
ただし、エージェントが何を知った状態で来るのかも見ておく必要があります。Chromeチームはブラウザ APIだけでなく、エージェントが参照する文書一式も配布しています。[そのガイド138本を数えたら、アクセシビリティが2本、検索が0本でした](/ja/blog/ja/modern-web-guidance-agent-skill-coverage-2026/)。エンドポイントを開けておいても、エージェント側の辞書にその概念がなければ呼び出しは来ません。
