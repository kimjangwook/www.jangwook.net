...
この成果はarXivにプレプリントとして公開され、プリンストン高等研究所、ハーバード大学、ケンブリッジ大学の研究者との共同研究として発表されました。AIが科学研究において「ツール」から「発見者」へと変わる歴史的な転換点と言えるでしょう。2026年2月はこの成果を含め、AIモデルの進歩が特に集中した月でした。[2026年2月AIモデルラッシュまとめ](/ja/blog/ja/ai-model-rush-february-2026)で当時の流れ全体を確認できます。
...
12時間にわたる形式的証明の完成は、AIが短時間の応答だけでなく、長時間の深い思考が可能であることを示しています。[MITのSOAR研究（自己カリキュラム型推論）](/ja/blog/ja/mit-soar-self-curriculum-reasoning)も同様の方向性を示しており、AIが自ら学習課題を設計することで推論能力を拡張する取り組みを紹介しています。
...
- <strong>AIの推論能力の進化</strong>：12時間の連続推論と形式的証明は、コード生成やバグ修正を超えた能力を示唆。[IBMのGenZ開発者採用に見るAIの限界分析](/ja/blog/ja/ibm-gen-z-hiring-ai-limits)では、エンジニアに求められるスキルがどう変化しているかも確認できます。
