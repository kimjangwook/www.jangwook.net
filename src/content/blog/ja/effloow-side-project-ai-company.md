...
[前回の記事でPaperclipというAIエージェントオーケストレーションプラットフォームをインストールして動かしてみました](/ja/blog/ja/paperclip-zero-human-company-agent-orchestration/)。エージェントを採用し、イシューを割り当て、コードをコミットするところまで確認しましたが — そこで止めるのはもったいなかったのです。
