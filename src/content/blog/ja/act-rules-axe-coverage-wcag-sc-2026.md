...
数える対象がルールではなく文書でも、同じ偏りが出る。[Chromeがエージェントに渡すガイド138本をカテゴリ別に数えたら、アクセシビリティは2本だった](/ja/blog/ja/modern-web-guidance-agent-skill-coverage-2026/)。チェッカーが何を決めるかを数える作業と、エージェントが何を読んで答えるかを数える作業は、結局同じ問いだ。
