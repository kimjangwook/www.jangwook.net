...
Read `data/column-brief.md`. The spec turns what was measured into one image that carries the article's finding on its own.
...
- Every item traces to the 브리프. Do not invent a row to balance the columns.
