...
Remember: Codex is capable of extraordinary creative work. Don't hold back - show what can truly be created when thinking outside the box, committing fully to a distinctive vision, **and grounding every decision in evidence-based UX psychology**.
