...
**Example**:
```
"Codex Agent Skills의 Progressive Disclosure 아키텍처부터 실전 구현, 5가지 시행착오 해결책, 토큰 44% 절감 성과까지."
```
...
```json
{
  "posts": [
    {
      "slug": "Codex-skills-implementation-guide",
      "language": "ko",
      "pubDate": "2025-10-22",
      "title": "Codex Skills 완벽 가이드",
      "summary": "...",
      "mainTopics": [...],
      "techStack": [...],
      "difficulty": 3,
