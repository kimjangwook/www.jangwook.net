  ...
  "trending_topics": [
    {
      ...
      "technologies": ["OpenAI", "Codex API", "GitHub Actions"],
  ...
  "keyword_opportunities": [
    {
      ...
      "competition": "medium",
      "relevance": 0.9,
      "suggested_angle": "Compare Codex vs GitHub Copilot vs Cursor"
    }
  ],
  "search_summary": {
    "total_searches": 15,
...
- Command: `.Codex/commands/post-recommendation.md`
- Agent: `.Codex/agents/web-researcher.md`
