...
- [] MCP Server 개발 실전 가이드 (커스텀 MCP Server 개발부터 배포까지)
- [] Chrome DevTools MCP로 웹 성능 최적화하기 (Core Web Vitals 측정 및 최적화 자동화)
- [] Brave Search MCP로 AI 리서치 자동화 (웹 검색 자동화 및 콘텐츠 큐레이션)
- [] Playwright MCP로 웹 테스팅 자동화 (E2E 테스트 및 스크린샷 자동화)

### 실전 프로젝트 시리즈

- [] Astro Islands Architecture 완벽 가이드 (정적 사이트 최적화 및 Islands 패턴 활용)
- [] 다국어 블로그 SEO 최적화 전략 (한국어, 영어, 일본어 콘텐츠 최적화 노하우)
- [] Core Web Vitals 최적화 실전 (LCP, FID, CLS 개선 사례 및 측정 자동화)
- [] 블로그 댓글 시스템 구축 (Giscus) (GitHub Discussions 기반 댓글 시스템 통합)

### AI 에이전트 활용 사례

- [] AI 에이전트로 소셜 미디어 관리 자동화 (LinkedIn, Twitter(X) 자동 포스팅 파이프라인)
- [] Claude Code로 포트폴리오 자동 업데이트 (GitHub 프로젝트 자동 분석 및 포트폴리오 반영)
- [x] AI 기반 콘텐츠 추천 시스템 구축 (유사 포스트 추천 및 관련 링크 자동 생성)

### 개발 생산성 팁

- [] .mcp.json 환경 변수 설정 가이드 (`alias='set -a && source .env && set +a && claude'` 활용법)
- [] Claude Code 커스텀 슬래시 커맨드 만들기 (반복 작업 자동화를 위한 커스텀 커맨드)
- [] AI 코드 리뷰 자동화 워크플로우 (품질 검증 자동화 및 베스트 프랙티스)
...
- [x] 주 2-3회 기술 블로그 포스팅 일정 수립
- [x] 프로젝트 케이스 스터디 작성 (최소 1개)
- [x] SEO 최적화된 제목 및 메타 설명 가이드라인 작성
  - [x] `.claude/guidelines/seo-title-description-guidelines.md` 생성
  - [x] 제목(Title) 최적화 가이드라인 (길이, 구조, 키워드 배치)
  - [x] 메타 설명(Description) 최적화 가이드라인 (길이, 패턴, 필수 요소)
  - [x] 언어별 최적화 전략 (한국어, 영어, 일본어)
  - [x] 기술적 SEO 요구사항 (Schema, 메타태그, 구조화된 데이터)
  - [x] 실전 예시 (좋은 예 vs 나쁜 예)
  - [x] SEO 체크리스트 (제목, 설명, 기술적 SEO, 다국어)
